...
> **Astuce examen** : Shebang obligatoire `#!/bin/bash` — rendre le script exécutable avec `chmod +x`.
...
> **RHEL 10** : **NetworkManager** est l'unique gestionnaire réseau. `network-scripts` définitivement supprimé.
...
> `loginctl enable-linger <user>` pour les services utilisateur persistants.

---

## 🎯 Rappels Examen EX200

| Point clé | Détail |
|-----------|--------|
| ⏱️ Durée | 3 heures — entièrement pratique |
| 🖥️ Environnement | 2 VMs RHEL 10 fournies |
| 📵 Ressources | Aucun accès internet — `man` et `--help` disponibles |
| ✅ Validation | Score minimum **210/300** pour être certifié |
| 🔁 Persistance | Les configurations doivent **survivre au redémarrage** |
| 🔐 SELinux | Ne jamais désactiver SELinux — corriger les contextes |
| 💡 Astuce | Tester avec `systemctl reboot` en fin d'examen |
...
*RHCSA EX200 — RHEL 10 — 2026*# 📋 RHCSA — Guide de Connaissances Requises
**Examen EX200** | Red Hat Enterprise Linux 10 | Version 2026  
Certification : *Red Hat Certified System Administrator*
